...
import { Body, ClienteData } from "../core/models/cliente";
...
export class PlanCuentasComponent implements AfterViewInit, OnInit {
    ...
    ngOnChanges(changes: SimpleChanges) {
        if (changes["quesera"] && changes["quesera"].currentValue) {
            ...
            this.nombre = this.quesera.str_cliente_nombre
            this.srvCuentas.obtenerCuentasDelCliente(this.quesera.int_cliente_id);
        }
    }
    ...
    ngOnInit(): void {
        ...
        if(this.quesera){
            this.nombre = this.quesera.str_cliente_nombre
            this.idCliente = this.quesera.int_cliente_id;
        }else{
        ...
        this.dataSourceHijas = new MatTableDataSource(
    ...
    obtenerCuentasPrincipales() {
        return this.cuentas.filter(
            (cuenta) => cuenta.int_cuenta_padre_id === null
        );
    }
